...
| **`R-UI-1`** | **Multi-Role User Experience:** Interactive dashboards for Proposer, Counterparty, Observer, Governance, Demo, and Metrics. | SRD §1, PRD §7 | `frontend/app/` (6 Next.js pages) | `npm run build` (10/10 routes statically prerendered) | **VERIFIED & PASSING** |

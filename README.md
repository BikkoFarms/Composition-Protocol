...
[PRD](docs/Composition_Protocol_PRD.pdf) · [SRD](docs/Composition_Protocol_SRD.pdf) · [Design (Lattice)](docs/DESIGN.md) · [DevNet](docs/DEVNET.md) · [Interviews](docs/INTERVIEWS.md) · [Implementation plan](docs/IMPLEMENTATION_PLAN.md)
